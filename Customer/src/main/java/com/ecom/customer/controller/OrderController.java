...
import com.ecom.library.service.*;
...
public class OrderController {
    ...
    public String checkOut(Principal principal, Model model){
        if(principal == null){
            ...
            if (customer.getAddress() == null || customer.getCity() == null || customer.getPhoneNumber() == null) {
                ...
                return getString(model, customer, countryService, cityService);
            } else {
    ...
    static String getString(Model model, CustomerDto customer, CountryService countryService, CityService cityService) {
